    ...
    <>
      ...
      <footer className="bg-blue-100 text-black font-poppins">
          ...
          <div>
            ...
            <ul className="space-y-3 text-black text-sm">
              <li className="flex items-start gap-2">
                ...
                Rani Avanti Chowk, Near Chouragade Medical, Gondia
              </li>
              <li className="flex items-center gap-2">
                <Mail size={18} /> theroyal.gondia@gmail.com
              </li>
              <li className="flex items-center gap-2">
                <Phone size={18} /> +91 7775009945
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ${
                openSection === "newsletter"
                  ? "max-h-[500px] mt-2"
                  : "max-h-0 lg:max-h-none lg:mt-3"
              }`}
            >
              <p className="text-black text-sm mb-4">
                Subscribe to our weekly student newsletter for inspirational
                stories and get 10% off your first purchase.
              </p>
              ...
              <div className="flex mb-4">
                ...
                />
                <button className="bg-blue-600 text-white  px-4 rounded-r-md text-sm font-semibold">
                  Subscribe
                </button>
              </div>
        ...
        <div className="bg-blue-600 text-white text-center text-sm py-3 mb-16 md:mb-0">
          Copyright © {new Date().getFullYear()} UnFoldBoook Publication. All
          rights reserved.
        </div>
      </footer>
    </>
